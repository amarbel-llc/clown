...
# (github.com/amarbel-llc/ringmaster, which carries the jobwake + jobmcp
...
# github.com/amarbel-llc/ringmaster v0.1.0` line (Go's parser needs a version;
...
{ ringmaster, system }:
{
  "github.com/amarbel-llc/ringmaster" = {
